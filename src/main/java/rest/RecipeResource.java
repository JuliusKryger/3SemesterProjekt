...
public class RecipeResource {
    ...
    public String saveRecipes(@PathParam("userName") String userName, @PathParam("weekNumber") int weekNumber, String json) {
    ...
    public String getFoodPlan(@PathParam("userName") String userName, @PathParam("weekNumber") int weekNumber) {
